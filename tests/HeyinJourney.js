...
try {
 ...
 harness.assert(obj('Heyin').x>stay.x+150 && obj('Heyin').animation==='Walk','Follow resumes with the actual GLB walk animation');
 ...
 for(const [x,y] of [[200,950],[-300,850],[-650,550],[-650,350]]){await move(x,y);await harness.stepFrames(145);}
